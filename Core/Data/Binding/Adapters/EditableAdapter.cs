...
using TimeClock.Core.Data.Binding.Adapters.MetaData;

namespace TimeClock.Core.Data.Binding.Adapters
{
    /// <summary>
        ...
        IEditable
    {
        ...
        public EditableAdapter(TWrappedObject current)
        {
            ...
            _current = current;
            _metaData = TypeMetaDataRepository.GetFor(current.GetType(), typeof(TWrappedObject));
        }
